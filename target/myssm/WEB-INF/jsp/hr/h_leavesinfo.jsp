...
<script type="text/html" id="barDemo">
    ...
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">批准</a>
</script>
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'eid', title:'员工ID', width:100, fixed: 'left',}
                ,{field:'name', title:'姓名', width:120, edit: 'text'}
                ,{field:'departmentname', title:'部门名', width:160, edit: 'text'}
                ,{field:'dutyname', title:'职位', width:160, edit: 'text', sort: true}
                ,{field:'leaveday', title:'放假时间', width:200,sort: true}
                ,{field:'returnday', title:'收假时间', width:200,sort: true}
        ...
        table.on('tool(test)', function(obj){
            ...
            //console.log(obj)
            if(obj.event === 'del'){
                layer.confirm('请确定批准该员工的假条', function(index){


                    //请求数据
                    console.log(obj.data.id);
                    axios.get(`/hr/approveleave/`+obj.data.id)
                        .then(res => {

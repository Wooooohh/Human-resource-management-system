...
<script>
    ...
    layui.use('table', function(){
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('请确定批准该员工的离职申请', function(index){


                    //请求数据

                    axios.delete(`/hr/approvedimission/`+obj.data.appdate)
                        .then(res => {
                            alert(res.data.m);
                            location.reload();
                        })
